const PLATFORMS = {
  ...
  twitter: {
    ...
    url: 'https://www.x.com',
    bg: '#000000',
    svg: `<svg viewBox="0 0 24 24" fill="white"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>`,
  },
  linkedin: {
    name: 'LinkedIn',
...
document.getElementById('continueBtn').addEventListener('click', () => {
  ...
  chrome.storage.local.set(
    { onboardingComplete: true, approvedSites: approved, scanning: true },
    () => {
...
function showSuccessModal(approved) {
  ...
  Object.entries(PLATFORMS).forEach(([key, platform]) => {
    ...
    wrap.className = 'platform-icon-wrap';
    wrap.style.background = platform.bg;
    wrap.innerHTML = platform.svg;

    const label = document.createElement('span');
    label.className = 'platform-icon-name';
